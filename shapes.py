...
while not done:
    ...
    #pygame.draw.ellipse(screen, RED, [20, 20, 100, 100])
    ...
    pygame.draw.circle(screen, GREEN, [285, 130], 100)

    pygame.draw.ellipse(screen, BLACK, [220, 90, 25, 30], 2)
    pygame.draw.ellipse(screen, BLACK, [320, 90, 25, 30], 2)

    pygame.draw.arc(screen, BLACK, [210, 75, 150, 125], PI, 0, 2)
    pygame.draw.arc(screen, BLACK, [210, 75, 150, 125], PI, PI, 2)
